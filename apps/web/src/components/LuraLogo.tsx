  ...
  return (
    <div className={`inline-flex items-center gap-2.5 sm:gap-3 group select-none ${className}`}>
      ...
      <div className={`relative ${iconSizes[size]} shrink-0`}>
        ...
        {/* Icon Container */}
        <div className="relative w-full h-full rounded-2xl bg-white/10 p-0.5 shadow-xl flex items-center justify-center overflow-hidden border border-white/20 group-hover:scale-105 transition-transform duration-300">
          <svg
            viewBox="0 0 40 40"
            fill="none"
          ...
          >
            ...
            <rect width="40" height="40" rx="10" fill="#000000" fillOpacity="0.9" />
            ...
            <rect x="28" y="18" width="3" height="8" rx="1.5" fill="#a1a1aa">
      ...
      {showText && (
        <div className="flex flex-col">
          <span className={`${textSizes[size]} font-black tracking-tight text-white font-sans flex items-center leading-none`}>
            Lura<span className="text-zinc-400">Talk</span>
            <span className="w-1.5 h-1.5 rounded-full bg-white ml-1.5 shadow-sm shadow-white animate-pulse" />
          </span>
          {size === 'lg' || size === 'xl' ? (
